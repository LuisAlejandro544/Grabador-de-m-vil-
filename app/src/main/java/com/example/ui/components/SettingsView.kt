...
fun SettingsView(
    ...
    Column(
        ...
        VtuberSettingsCard(
            ...
            onTrackingModeSelected = vtuberEvents.onUpdateVtuberTrackingMode,
            onToggleHeadTilt = vtuberEvents.onToggleVtuberHeadTilt,
            onEyeBlinkSensitivityChanged = vtuberEvents.onUpdateVtuberEyeBlinkSensitivity,
            onMouthSensitivityChanged = vtuberEvents.onUpdateVtuberMouthSensitivity,
        ...
        // Mostrar Toques y Deslices Nativos del Sistema (60 FPS)
...
fun SettingsView(
    ...
    onUpdateVtuberTrackingMode: (VtuberTrackingMode) -> Unit = {},
    onToggleVtuberHeadTilt: (Boolean) -> Unit = {},
    onUpdateVtuberEyeBlinkSensitivity: (Float) -> Unit = {},
    onUpdateVtuberMouthSensitivity: (Float) -> Unit = {},
    ...
    SettingsView(
        ...
        vtuberEvents = VtuberSettingsEvents(
            ...
            onUpdateVtuberTrackingMode = onUpdateVtuberTrackingMode,
            onToggleVtuberHeadTilt = onToggleVtuberHeadTilt,
            onUpdateVtuberEyeBlinkSensitivity = onUpdateVtuberEyeBlinkSensitivity,
            onUpdateVtuberMouthSensitivity = onUpdateVtuberMouthSensitivity,
